    ...
    For Each w In vWorksheets
        ...
        With wks
            For iCol = 2 To wks.UsedRange.Columns.Count
                If Not IsError(.Cells(6, iCol)) And Not IsError(.Cells(8, iCol)) And Not IsError(.Cells(10, iCol)) Then
                    dealTo = .Cells(8, iCol)
                    ...
                    If Not IsEmpty(.Cells(6, iCol)) And .Cells(10, iCol) <> 0 And periodFrom <= dealTo Then
                        ...
                        For period = 1 To noPeriods
                            ...
                            Do Until rsNIS.EOF
                                ...
                                Else
                                    rsFacts.Fields(valueField) = -(rsNIS.Fields("NIS") / NIS) * (.Cells(10, iCol) / .Cells(9, iCol))
                                End If
                            ...
                            If -(.Cells(10, iCol) / .Cells(9, iCol)) <> AllocatedDiscount Then
                                ...
                                If rsSKU.RecordCount > 1 Then
                                    ...
                                    rsFacts.Fields(valueField) = -(.Cells(10, iCol) / .Cells(9, iCol)) - AllocatedDiscount
                                Else
