SELECT [a.101_salesreturnsoffinvtas]
       ...
       + [a.101_salesreturnsoninv] + [a.105_gosfap1]           AS GrossSalesValueInclCT,
       ...
       + a.discount1fix + [a.104_taefficiencyoninv]            AS OnInvoiceConditions,
       ...
       [a.22_3_5extracosts] + [a.displaycosts]                 AS TotDisplayCosts,
       ...
       + totdisplaycosts                                       AS CostOfGoodsExclCT,
       costofgoodsexclct + totcoffeetax                        AS CostOfGoodsInclCT,
       ...
       totcoffeetax + grosssalesvalueinclct                    AS GrossSalesValueExclCT,
       nosexclct + costofgoodsexclct                           AS GP,
       gp + totalap                                            AS MarketingCM,
       a.shipping + a.warehouse                                AS WD,
       wd + marketingcm                                        AS CM,
       a.otherga + a.selling + a.marketing
       + a.sellingoffice + a.sellingfield
       + a.controlling + a.finance + a.tax + a.it
       + a.humanresources + a.facility + a.legal
       + a.supplychain + a.generalmanagement                   AS OSA,
       cm + osa                                                AS Ebit,
